...
<form method="post" action='<?php echo $_SERVER['PHP_SELF']; ?>'  autocomplete="on"> 	
    <textarea name='str' id='str' style='width:600px;height:200px;' required="required" placeholder="输入汉字" autofocus="autofocus" ></textarea><br/>
    <input type="submit" name="convert" value="提交">
</form>
<div>
<?php 
$str = isset($_POST['str'])?$_POST['str']:'';
echo Pinyin($str,'utf8');?>
...
//测试
//echo Pinyin('中文测试','utf8'); //第二个参数“1”可随意设置即为utf8编码
?>
